...
import "./InvestissementPerformance.scss";
...
const InvestissementPerformance = () => {
  return (
    <div className="InvestissementPerformance ">
      <h2>Performance (rendement)</h2>
      <div
        style={{ height: "100%" }}
      ...
      >
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            {/* <Legend /> */}
            <defs>
              <linearGradient id="gradient" x1="0" y1="20%" x2="0%" y2="120%">
                <stop offset="0" stopColor="#28BC2E" />
                <stop
                  offset="1"
              ...
              <linearGradient id="gradient1" x1="0" y1="20%" x2="0%" y2="120%">
                <stop offset="0" stopColor="#28B3BC" />
                <stop
                  offset="1"
                  stopColor="rgba(40, 179, 188, 0)"
                  opacity={0}
...
export default InvestissementPerformance;
