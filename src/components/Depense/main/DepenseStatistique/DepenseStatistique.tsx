...
const depenseType = ["Annuel", "Mensuel", "Hebdomadaire"];

const DepenseStatistique = () => {
  const [frequency, setFrequency] = useState(depenseType[0]);
  ...
  return (
    <div className="DepenseStatistique">
      <h2>
        ...
        >
          <SelectTrigger className="focus:ring-0 w-[180px] bg-[#db5151] outline-none border-none focus:shadow-none">
            <SelectValue placeholder="Select a " />
          </SelectTrigger>
          <SelectContent>
            <SelectGroup>
              <SelectLabel>Catégories</SelectLabel>
              {depenseType.map((item) => (
